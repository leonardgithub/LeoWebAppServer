...
*/
;(function() {
	// -----------------------------added by Leonard on 20131017 for chrome debug instead of phonegap debug, begin
	if(window.IsLeoPhonegap == null){
		return;
	}
	// -----------------------------added by Leonard on 20131017 for chrome debug instead of phonegap debug, end
...
if(window.cordova){// -----------------------------added by Leonard on 20131017 for chrome debug instead of phonegap debug
