...
var a = function() {
    ...
    c.amendUrl = function(b) {
        ...
        "");
        var e = b.split("/");
        if (e[0] === "http:" && /:80$/.test(e[2]) || e[0] === "https:" && /:443$/.test(e[2])) e[2] = e[2].replace(/:(80|443)$/, "");
        return b = e.join("/"),
        b
    },
...
sae.Channel.bootstrap_iframe = a.bootstrap_iframe,
"_sockjs_onload" in window && setTimeout(_sockjs_onload, 1),
typeof define == "function" && define.amd && define("sae", [],
function() {
    return sae
})
